...
<button className="btn sidebar-button py-2 text-start">Sample Copy for...</button>
    ...
    <p className="text-secondary">Welcome back, <span className="fw-bold text-white">Jal Patel</span></p>
    
    <div
      className="resizer bg-secondary"
      style={{ width: "5px", cursor: "ew-resize", height: "100%", position: "absolute", right: 0, top: 0 }}
...
<div className="d-flex flex-column bg-white  flex-grow-1" style={{ paddingBottom: "20px" }}> 
  ...
  onError={(e) => { 
    ...
    e.target.src = "https://static.vecteezy.com/system/resources/thumbnails/048/334/475/small_2x/a-person-icon-on-a-transparent-background-png.png"; 
  }}
/>
